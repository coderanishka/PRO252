...
cred = credentials.Certificate("potentiometer-11133-firebase-adminsdk-gv2al-5d0697eab5.json")
...
def add():
    try:
        ...
        db_client.collection('data').document('data').set({'potentiometer_value' : pot_val})
